<!--
Что здесь можно сдлеать и добааить 

1. Добавить блок по soft skils и hard skils. Это сразу можно перед блоком Tech Stack 
2. Также перед soft skils и hard skils поставить блок с направлениями какие я предлагаю 
3. Поменять уже имеющиесь иконки для стистики, сделать это все прям кастамно, чтобы прям под мой стиль и очень красиво
-->
...
можно Инстаграм как оформлю 
-->

<!--
1. Нужно будет поменять бы иконки на более красивые 
2. Сделать чтобы нажав на иконку, человек бы переходил на мой проект с этим языком и т.д, 
3. Также сдеалть чтобы если нажать на, к примеру, Frontend, то пользователь переходил на лучший проект с ним 
4. Разделить грамотно по всем обзацам все навыки 
5. сделать прям много всех самых разных навыков 
-->

<!--
# 💻 Tech Stack:

![CSS3](https://img.shields.io/badge/css3-%231572B6.svg?style=plastic&logo=css3&logoColor=white) ![GraphQL](https://img.shields.io/badge/-GraphQL-E10098?style=plastic&logo=graphql&logoColor=white) ![HTML5](https://img.shields.io/badge/html5-%23E34F26.svg?style=plastic&logo=html5&logoColor=white)
